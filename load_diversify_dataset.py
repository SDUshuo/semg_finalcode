import numpy as np
from PyTorchImplementation.CWT import calculate_wavelet
...
def read_data(path,preOrEva='training0'):
    ...
    np.save('/home/yanshuo/YS/diversify/data/emg/emg_x_test.npy', np.array(list_dataset))
    np.save('/home/yanshuo/YS/diversify/data/emg/emg_y_test.npy', np.array(y_candidate))
