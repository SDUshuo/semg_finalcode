...
if __name__ == '__main__':
    ...
    examples_training, labels_training,s = datasets_training

    datasets_validation0 = np.load(test0_datapath, encoding="bytes",allow_pickle=True)
    examples_validation0, labels_validation0,b = datasets_validation0

    datasets_validation1 = np.load(test1_datapath, encoding="bytes",allow_pickle=True)
    examples_validation1, labels_validation1,f = datasets_validation1
