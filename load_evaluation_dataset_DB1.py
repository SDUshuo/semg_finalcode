...
newpath ='saved_data/DB1/' + window_path + '/' + window_path + '_exercise1_2ge_dataAug/subject_'
"""
_exercise1_jitr_norm训练及测试机都是用了家噪音和normlize  家噪音确实效果编号了
_exercise1只用了norm
_exercise1_4ge_dataAug  加入了四种数据增强的方式扩充数据及
"""
...
#原来的备份
def read_data_aug(number_of_vector_per_example = 200,
size_non_overlap = 50):
    print("Reading Data")
